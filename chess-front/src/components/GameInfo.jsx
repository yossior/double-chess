 ...
 */
export default function GameInfo({ isOnline, online, gameStatus, isMyTurn, turn, movesInTurn }) {
  return (
    <div className="game-info p-2 border rounded">
      ...
      <div><strong>Move:</strong> {movesInTurn !== undefined ? `${movesInTurn + 1}/2` : "1/1"}</div>
